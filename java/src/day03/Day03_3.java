...
public class Day03_3 {
	...
	//게임에서 상점 이용하기 프로그램
		//조건1 : 한명회원 [ 아이디 : qwe 비밀번호: 1234 ]
			//로그인창 만들어서 아이디와 비밀번호를 입력받아 동일한경우 상점 이용 하기
				//동일하지 않으면 로그인 실패
		//조건2 : 기존 5000원 가지고 있음
	...
	public static void main(String[] args) {
		...
		while(true){ //while 반복문 시작 괄호 // 무한루프
		
			System.out.println("-----> 로그인 창 ");
			System.out.println("아이디: " ); String 아이디 = scan.next();
			System.out.println("비밀번호: " ); int 비밀번호 = scan.nextInt();
				...
				if( 아이디.equals("qwe") && 비밀번호 == 1234 ) {
					...
					while(true) { //while
						...
						if( 선택 == 4 ) {
							...
							if(과일구매수 != 0) System.out.println("과일\t"+과일구매수+"\t"+과일구매수*100);
							if(장신구구매수 != 0) System.out.println("장신구\t"+장신구구매수+"\t"+장신구구매수*100);
